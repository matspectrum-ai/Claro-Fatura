...
// web is the public product UI. It is embedded in the Go binary so production
// does not require Node.js, a JS build pipeline, or a separate static server.
//
//go:embed web
